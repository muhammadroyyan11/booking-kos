...
Route::get('tespdf', function (Codedge\Fpdf\Fpdf\Fpdf $fpdf) {
...
Route::get('/about', 'Frontend\FrontendsController@about'); // homepage
Route::get('/syarat-ketentuan', 'Frontend\FrontendsController@syarat'); // homepage
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/admin')->middleware('role:Admin')->group(function () {
        ...
        Route::resources([
            '/penghuni' => 'Admin\PenghuniController'
        ]);

        Route::get('status-kamar', 'Admin\AdminController@statusKamar');
        Route::get('laporan', 'Owner\LaporanController@index'); //Laporan
//        Route::post('cetak', 'Owner\LaporanController@laporan')->name('laporan.cetak');; //Laporan
        Route::post('laporan/cetak', [\App\Http\Controllers\Owner\LaporanController::class, 'cetak']); //Laporan
    });
